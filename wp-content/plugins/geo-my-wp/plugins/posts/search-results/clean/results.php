...
<div class="gmw-results-wrapper gmw-results-wrapper-<?php echo $gmw['ID']; ?> gmw-pt-results-wrapper">
	...
	<div class="nav nav-tabs" role="tablist" id="listingTab_tmp">
	...
	<div class="gmw-posts-wrapper">
		...
		<!--  taxonomies -->
				<div id="wppl-taxes-wrapper" class="category_name">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class( 'wppl-single-result '.$featured ); ?>>
			...
			<span class="number_listing"><?php echo $post->post_count; ?>. </span>
						
				<!-- Title -->
				<span class="heading_title"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
							<?php the_title(); ?> 
						</a></span>
				<span class="distance_from"><?php gmw_distance_to_location( $post, $gmw ); ?></span>
				<span class="">
			...
			<span class="address_value fa fa-map-marker address-icon">
					<!--  Driving Distance -->
